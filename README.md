...
We also faced request limits when using an api for articles that showcase the sentiment of the market.  With more funding for a premium plan an ETL pipeline could've been finished.
